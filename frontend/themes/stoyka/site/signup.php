    ...
    <div class="content">
        ...
        <div class="block clear login-block register">
            <?php $form = ActiveForm::begin(['id' => 'form-signup', 'class' => 'sign-up']); ?>
                ...
                <p style="margin-top: 20px;font-size: 16px;font-weight: 700;">Нажмимая кнопку "Регистрация", вы тем самым соглашаетесь с правилами обслуживания клиентов компании Бар "Стойка", порядком оказания услуг и информирования клиентов о заказах, новинках и проводимых акциях.</p>
